...
import demo.stori.account.statement.util.JsonUtil;
...
import static demo.stori.account.statement.constants.RabbitConstants.ATTRIBUTE_DEAD_LETTER_EXCHANGE;
import static demo.stori.account.statement.constants.RabbitConstants.ATTRIBUTE_DEAD_LETTER_ROUTING_KEY;
import static demo.stori.account.statement.constants.RabbitConstants.ATTRIBUTE_MESSAGE_TTL;
import static demo.stori.account.statement.constants.RabbitConstants.NEW_TRANSACTION_DEAD_LETTER_ROUTING_KEY;
import static demo.stori.account.statement.constants.RabbitConstants.NEW_TRANSACTION_QUEUE;
import static demo.stori.account.statement.constants.RabbitConstants.STORI_EXCHANGE;
